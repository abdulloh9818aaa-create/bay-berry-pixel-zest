...
//#region node_modules/.nitro/vite/services/ssr/assets/router-Cxq1t6Kz.js
var router_Cxq1t6Kz_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-ZvuF2jyQ.css";
var APP_NAME = "Kingside";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Kingside — классические шахматы с полной логикой и машиной-соперником."
			}
		],
		links: [
			{
...
var $$splitComponentImporter = () => import("./routes-DQ9Bm_Ju.mjs").then((n) => n.t);
...
//#endregion
export { getRouter, router_Cxq1t6Kz_exports as t };
